...
class Head(Element):
    def __init__(self, parent, main, format_func=None):
    ...
    def drawText(self, event, qp):
        ...
        if self.format_func is not None:
            qp.drawText(event.rect(), QtCore.Qt.AlignLeft, self.format_func(self.main.min()))
        else:
...
class Tail(Element):
    ...
    def drawText(self, event, qp):
        ...
        qp.setFont(QtGui.QFont('Arial', 10))
        if self.format_func is not None:
            qp.drawText(event.rect(), QtCore.Qt.AlignRight, self.format_func(self.main.max()))
        else:
...
class Handle(Element):
    ...
    def drawText(self, event, qp):
        ...
        qp.setFont(QtGui.QFont('Arial', 10))
        if self.format_func is not None:
            qp.drawText(event.rect(), QtCore.Qt.AlignLeft, self.format_func(self.main.start()))
            qp.drawText(event.rect(), QtCore.Qt.AlignRight, self.format_func(self.main.end()))
        else:
...
class QRangeSlider(QtWidgets.QWidget, Ui_Form):
    ...
    def __init__(self, parent=None):
        ...
        self.tail = Tail(self._tail, main=self, format_func=self.format_func)
    ...
    def setRange(self, start, end):
        ...
        self.setStart(start)
        self.setEnd(end)
        # print('setRange', self._splitter.getRange(self._SPLIT_START))
        # print('setRange', self._splitter.getRange(self._SPLIT_END))
